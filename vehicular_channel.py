...
class Channel(object):
    ...
    def set_link_loss_cell(self, new_link_loss, tx_id):
        self.__link_loss_cell[tx_id] = new_link_loss

    def set_link_loss_mmwave(self, new_link_loss, tx_id):
        self.__link_loss_mmwave[tx_id] = new_link_loss
